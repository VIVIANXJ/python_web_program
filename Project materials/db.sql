...
-- ----------------------------
BEGIN;
INSERT INTO `auth_user` VALUES (9, 'pbkdf2_sha256$150000$DdXOxqtPWCdx$fX4cLVmYMw2g3PmfpwpZpSWm+IjsFa43UQeF9fQROgQ=', '2021-10-28 03:13:50.308339', 0, '1', '', '', '', 0, 1, '2021-10-28 03:13:42.773170');
INSERT INTO `auth_user` VALUES (10, 'pbkdf2_sha256$260000$taZGTh8KcFIZE2EAjuMbdL$n2PDEZGs8EvOrMjz+c4hT/QFBCJz+FtDXHFUALSkIIM=', '2021-11-04 02:22:00.390569', 0, 'manager0', '', '', '', 0, 1, '2021-11-03 17:27:42.799516');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `django_session` VALUES ('gfe1aeup821l1r22pw08wy60fc23j0on', '.eJxVjDsOwjAQRO_iGlleNv5R0nMGa722cQA5UpxUiLuTSClAmmrem3mLQOtSw9rzHMYkLgKUOP2WkfiZ207Sg9p9kjy1ZR6j3BV50C5vU8qv6-H-HVTqdVsrNuSZbQbWhiNoVDRYBc4aYxEH5x1gNmiVh3TOXLAYTQlwiy3Ri88X6L83RQ:1miK3A:nCi3OqjNOHgvzqAayKsQVgplOJ3ylADdwpd5OnK616c', '2021-11-17 17:27:48.852762');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `pro_templateaction` VALUES (15, '', NULL, NULL, NULL, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `pro_userprofile` VALUES (9, 'k', 'k', 'Team Member', 9);
INSERT INTO `pro_userprofile` VALUES (10, 'Test manager', 'Guo', 'Manager', 10);
COMMIT;
